...
(function () {
  ...
  var C = {
    en: {
      ...
      // round 16 (#2): music source — internal track vs this device's microphone
      'console.h.source': '🎚 Music source',
      'console.src_internal': '🎵 Internal music', 'console.src_mic': '🎤 Microphone (this device)',
      'console.mic_sens': 'Sensitivity',
      'console.src_hint': 'Point this device at the speakers. The lights follow the loudness it hears — no audio is recorded, stored or sent, only a single number about 20 times a second.',
      'console.mic_asking': 'Asking for microphone access…',
      'console.mic_live': '🎤 LIVE from the microphone — the crowd follows what this device hears.',
      'console.mic_off': 'Back to the internal music. Press Start (or GO) to play a track again.',
      'console.mic_denied': 'No microphone access. Allow it in the browser (the page must be https) and try again.',
      'console.mic_unsupported': 'This browser cannot open a microphone. Use Chrome or Safari over https.',
      'console.mic_meter_hint': "The bar is what the crowd gets. The dashed line is this room's own quiet — anything below it is ignored, so noise never drives the lights.",
      'console.mic_off_short': 'off',
      'console.mic_over_room': 'over the room', 'console.mic_below_gate': 'below the gate, ignored',
      'console.start_failed': 'could not start — press Start again',
      'console.manual_full_on': 'Manual control is ON (presets off) — the crowd shows your colour, not the show.', 'console.manual_on': 'Manual control is ON — your colour is layered over the show.', 'console.manual_back': 'Back to the show',
      'console.mic_delay': 'Beat delay', 'console.mic_delay_none': 'none',
      'console.mic_delay_hint': 'The lights always trail the room a little — the sound has to reach this device, then every phone. You cannot take that away, so add to it: raise the delay until the flashes land on the NEXT beat. A beat is 500 ms at 120 BPM.',
      'console.mic_hidden': 'Microphone paused — this page must stay open and unlocked while it drives the lights.',
      'console.armed_label': 'Armed:', 'console.state_label': 'State:',
      'console.preview_label': "Live preview — one bar per phone, exactly what those screens are showing right now (safety-governed):",
    ...
    pl: {
      ...
      // round 16 (#2): źródło muzyki — utwór wewnętrzny albo mikrofon tego urządzenia
      'console.h.source': '🎚 Źródło muzyki',
      'console.src_internal': '🎵 Muzyka wewnętrzna', 'console.src_mic': '🎤 Mikrofon (to urządzenie)',
      'console.mic_sens': 'Czułość',
      'console.src_hint': 'Skieruj to urządzenie w stronę głośników. Światła podążają za głośnością, którą słyszy — dźwięk nie jest nagrywany, zapisywany ani wysyłany, wysyłana jest tylko jedna liczba około 20 razy na sekundę.',
      'console.mic_asking': 'Proszę o dostęp do mikrofonu…',
      'console.mic_live': '🎤 NA ŻYWO z mikrofonu — tłum reaguje na to, co słyszy to urządzenie.',
      'console.mic_off': 'Powrót do muzyki wewnętrznej. Naciśnij Start (lub GO), aby znów odtworzyć utwór.',
      'console.mic_denied': 'Brak dostępu do mikrofonu. Zezwól na niego w przeglądarce (strona musi być na https) i spróbuj ponownie.',
      'console.mic_unsupported': 'Ta przeglądarka nie może otworzyć mikrofonu. Użyj Chrome lub Safari na https.',
      'console.mic_meter_hint': 'Pasek to jest to, co dostaje tłum. Linia przerywana to własna cisza tej sali — wszystko poniżej jest ignorowane, więc szum nigdy nie steruje światłami.',
      'console.mic_off_short': 'wył.',
      'console.mic_over_room': 'nad ciszą sali', 'console.mic_below_gate': 'poniżej progu, ignorowane',
      'console.start_failed': 'nie udało się uruchomić — naciśnij Start ponownie',
      'console.manual_full_on': 'Sterowanie ręczne WŁĄCZONE (presety wyłączone) — telefony pokazują Twój kolor, nie pokaz.', 'console.manual_on': 'Sterowanie ręczne WŁĄCZONE — Twój kolor nakłada się na pokaz.', 'console.manual_back': 'Wróć do pokazu',
      'console.mic_delay': 'Opóźnienie do rytmu', 'console.mic_delay_none': 'brak',
      'console.mic_delay_hint': 'Światła zawsze trochę spóźniają się za salą — dźwięk musi dotrzeć do tego urządzenia, a potem do każdego telefonu. Tego nie da się cofnąć, więc dodaj: zwiększaj opóźnienie, aż błyski trafią w NASTĘPNY takt. Przy 120 BPM takt to 500 ms.',
      'console.mic_hidden': 'Mikrofon wstrzymany — ta strona musi pozostać otwarta i odblokowana, gdy steruje światłami.',
      'console.armed_label': 'Załadowany:', 'console.state_label': 'Stan:',
      'console.preview_label': 'Podgląd na żywo — jeden pasek na telefon, dokładnie to, co teraz pokazują te ekrany (z zabezpieczeniem):',
